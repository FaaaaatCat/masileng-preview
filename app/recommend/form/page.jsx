...
const WEATHER_OPTIONS = [
  ...
  {
    key: "cloudy",
    icon: "/recommend_icon/Property 1=2.littleCloud.png",
    label: "약간 흐림",
  },
  {
    key: "rainy",
    icon: "/recommend_icon/Property 1=3.rainy.png",
    label: "높은 비",
  },
  {
    key: "overcast",
    icon: "/recommend_icon/Property 1=4.cloudy.png",
    label: "구름 많음",
  },
  {
    key: "storm",
    icon: "/recommend_icon/Property 1=5.thunder.png",
    label: "폭풍우",
  },
...
const SITUATION_OPTIONS = [
  {
    key: "party",
    icon: "/recommend_icon/Property 1=1.party.png",
    label: "파티",
  },
  {
    key: "anniversary",
    icon: "/recommend_icon/Property 1=2.calendar.png",
    label: "기념일",
  },
  {
    key: "formal",
    icon: "/recommend_icon/Property 1=3.suit.png",
    label: "격식있게",
  },
  {
    key: "bright_date",
    icon: "/recommend_icon/Property 1=4.sunny.png",
    label: "밝은 데이트",
  },
  {
    key: "night_date",
    icon: "/recommend_icon/Property 1=5.night.png",
    label: "심야 데이트",
  },
  {
    key: "nightout",
    icon: "/recommend_icon/Property 1=6.something.png",
    label: "밤밖에 말까",
  },
  {
    key: "deep_talk",
    icon: "/recommend_icon/Property 1=7.talk.png",
    label: "진중한 대화",
  },
  {
    key: "alone",
    icon: "/recommend_icon/Property 1=8.solo.png",
    label: "혼자의 휴일",
  },
  {
    key: "whatever",
    icon: "/recommend_icon/Property 1=9.noMatter.png",
    label: "상관 없음",
  },
];
...
const LOCATION_OPTIONS = [
  {
    key: "indoor",
    icon: "/recommend_icon/Property 1=1.home.png",
    label: "집에서 만들어요",
  },
  {
    key: "outdoor",
    icon: "/recommend_icon/Property 1=2.bar.png",
    label: "밖에서 한잔해요",
  },
];
      ...
      <div className="recommend-page-root">
        <div className="recommend-page-wrap">
          <span
            style={{
              fontSize: 80,
              animation: "rec-bounce 0.8s ease-in-out infinite alternate",
            }}
          >
            🍹
          </span>
          ...
          >
            ...
            >
              <p
                ...
                style={{ color: "var(--dark-6)", letterSpacing: "0.1em" }}
              >
                STEP 0{step + 1}
              </p>
              {step > 0 && (
                <button
                  onClick={goBack}
                  className="btn btn-transparent btn-sm btn-dark"
                >
                  ← 이전
                </button>
              )}
            ...
            <div className="h-full">
              <div
                ...
                style={{
                  gridTemplateColumns: `repeat(${current.grid}, 1fr)`,
                }}
              >
                {current.options.map((opt) => {
                  ...
                  const sizeClass =
                    current.grid === 2
                      ? "recommend-option--grid2"
                      : "recommend-option--grid3";
                  return (
                    <button
                      key={opt.key}
                    ...
                    >
                      {opt.icon ? (
                        <img
                          src={opt.icon}
                          alt={opt.label}
                          className="recommend-option-icon"
                        />
                      ) : (
                        <span className="recommend-option-emoji">
                          {opt.emoji}
                        </span>
                      )}
                      <span className="recommend-option-label">
                        {opt.label}
                      </span>
                    </button>
                  );
