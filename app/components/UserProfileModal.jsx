...
const AVATAR_COLORS = ["#F34B65", "#FFC355", "#6C63FF", "#3ABEF9", "#52C87A", "#F98162", "#9B51E0"];
...
export default function UserProfileModal({ username, onClose }) {
  ...
  const userCards = CARDS.map((c, i) => ({ ...c, _id: i })).filter((c) => c.u === username);
    ...
    >
      <div className="profile-modal">
        ...
        <div className="profile-modal-header">
          <h2 className="profile-modal-title">유저 프로필</h2>
          <button className="profile-modal-close" onClick={onClose} aria-label="닫기">✕</button>
        </div>
        ...
        <div className="profile-user-section">
          ...
          <div className="profile-user-info">
            ...
            <div className="profile-stats">
              ...
              <div className="profile-stat">
                <span className="profile-stat-value">{totalLikes.toLocaleString()}</span>
        ...
        <div className="profile-recipes-section">
          <h4 className="profile-recipes-title">등록한 레시피 ({userCards.length})</h4>
          <div className="profile-recipes-list">
            {userCards.length === 0 ? (
              <p className="profile-recipes-empty">아직 등록한 레시피가 없어요.</p>
            ) : (
              userCards.map((card) => {
                ...
                return (
                  <Link
                    ...
                    onClick={onClose}
                  >
                    <div className="profile-recipe-thumb" style={{ background: poolImg?.g }}>
                      <img
                        src={poolImg?.url}
                        alt={card.t}
                    ...
                    <div className="profile-recipe-info">
                      ...
                      <span className="profile-recipe-meta">{card.base} · {card.theme}</span>
                    </div>
